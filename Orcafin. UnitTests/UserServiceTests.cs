...
namespace Orcafin.UnitTests
{
    public class UserServiceTests
    {
        ...
        {
            // Arrange
            var existingUser = new User { Id = 1, Name = "Existing User", Email = "existing@example.com", Login = "existing.user", Cpf = "11111111111" };
            var request = new UserUpdateRequest
            {
                Name = "Updated User",
                Email = "another@example.com",
                Login = "updated.user",
                Cpf = "22222222222" // CPF válido para o teste
            };
            var userWithSameEmail = new User { Id = 2, Name = "Another User", Email = "another@example.com", Login = "another.user", Cpf = "33333333333" };
        ...
        public async Task UpdateAsync_ShouldThrowException_WhenLoginAlreadyExistsForAnotherUser()
        {
            ...
            var userWithSameLogin = new User { Id = 2, Name = "Another User", Email = "another@example.com", Login = "another.user", Cpf = "33333333333" };
        ...
        public async Task UpdateAsync_ShouldThrowException_WhenCpfAlreadyExistsForAnotherUser()
        {
            ...
            var userWithSameCpf = new User { Id = 2, Name = "Another User", Email = "another@example.com", Login = "another.user", Cpf = "22222222222" };
